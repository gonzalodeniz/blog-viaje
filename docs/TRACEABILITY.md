...
| RF-R1-03 | WP-R1-2 | TASK-R1-007, TASK-R1-011, TASK-R1-012, TASK-R1-013 | 1e30691, a3cb88a, 66622a2 | — | — |
| RF-R1-04 | WP-R1-2 | TASK-R1-007, TASK-R1-011, TASK-R1-012, TASK-R1-015 | 1e30691, a3cb88a | backend/app/api/auth.py, backend/app/services/auth.py, backend/tests/test_api_auth.py, backend/tests/test_auth_service.py | backend/tests/test_api_auth.py, backend/tests/test_auth_service.py |
| RF-R1-05 | WP-R1-2, WP-R1-5 | TASK-R1-007, TASK-R1-011, TASK-R1-012, TASK-R1-013 | 1e30691, a3cb88a, 66622a2 | — | — |
| RF-R1-06 | WP-R1-2, WP-R1-5 | TASK-R1-007, TASK-R1-009, TASK-R1-011, TASK-R1-014 | 1e30691, a3cb88a, 361a3c7, 388a392 | — | — |
| RF-R1-07 | WP-R1-2 | TASK-R1-007, TASK-R1-008, TASK-R1-011, TASK-R1-013, TASK-R1-014 | 1e30691, a3cb88a, b94ca9b, 635a4bd, 66622a2 | backend/app/api/deps.py | backend/tests/test_api_admin_photos.py, backend/tests/test_api_admin_topics.py, backend/tests/test_api_admin_trips.py |
| RF-R1-08 | WP-R1-3 | TASK-R1-011 | — | backend/app/cli/main.py, backend/tests/test_cli.py | backend/tests/test_cli.py |
| RF-R1-09 | WP-R1-3 | TASK-R1-011 | — | backend/app/cli/main.py, backend/app/services/rescue_cli.py, backend/tests/test_cli.py | backend/tests/test_cli.py |
| RF-R1-10 | WP-R1-3 | TASK-R1-007, TASK-R1-011 | 1e30691, a3cb88a | backend/app/cli/main.py, backend/app/services/rescue_cli.py, backend/tests/test_cli.py | backend/tests/test_cli.py |
| RF-R1-11 | WP-R1-3 | TASK-R1-011 | — | backend/app/cli/main.py, backend/app/models/account_lock.py, backend/app/services/rescue_cli.py, backend/tests/test_cli.py | backend/tests/test_cli.py |
| RF-R1-12 | WP-R1-3 | TASK-R1-009, TASK-R1-011 | 361a3c7, 388a392 | backend/app/cli/main.py, backend/app/services/rescue_cli.py, backend/tests/test_cli.py | backend/tests/test_cli.py |
...
| RF-R1-19 | WP-R1-5 | TASK-R1-011 | — | — | — |
| RF-R1-20 | WP-R1-2 | TASK-R1-007, TASK-R1-011, TASK-R1-015 | 1e30691, a3cb88a | — | — |
...
| RNF-R1-04 | WP-R1-1 | TASK-R1-003, TASK-R1-004, TASK-R1-011 | d9417e0, 49c9646, b8503d2, 311267a | — | — |
...
| RNF-R1-08 | WP-R1-2 | TASK-R1-007, TASK-R1-011, TASK-R1-012, TASK-R1-016 | 1e30691, a3cb88a | — | — |
